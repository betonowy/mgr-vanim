...
void encode_to_i8(const cube_888_f32 *, cube_888_i8 *, float *quantum, float *min, uint8_t quantization_limit);
void decode_from_i8(const cube_888_i8 *, cube_888_f32 *, float quantum, float min, uint8_t quantization_limit);

void to_i8(const cube_888_f32*, cube_888_i8*);
void from_i8(const cube_888_i8*, cube_888_f32*);
} // namespace dvdb
